...
fato do sistema ter sido criado com o código totalmente
 aberto fez com que o número de usuários aumenta 
...
tecnologias. \textit{RouteFlow} faz a 
manipulação do protocolo \textit{OpenFlow} 
utilizando os softwares de controle mais populares 
...
questão descreve a adição de suporte a um novo 
software de controle, o \textit{Floodlight},  
criado totalmente em \textit{Java}. Sendo assim, 
o \textit{RouteFlow} ganhara suporte a mais uma
...
project, led by the CPqD Foundation, proposes a platform
...
effective separation of the control plane of routing
 ...
 the number of users to  increase considerably encouraging
 the development team to update it by constantly adding 
more and more tools and technologies. 
 \textit{RouteFlow} manipulate  the 
...
addiction of support for a new controller, 
\textit{Floodlight}, created entirely in 
